...
//         .selectAll('path')
//         .attr('class', (_, idx) => {
//           // Apply 'selected' class if idx matches selectedIndex, otherwise no class
...
//         .selectAll('li')
//         .attr('class', (_, idx) => {
//           return idx === selectedIndex ? 'selected' : ''; // Apply 'selected' class based on the selectedIndex
//         });
//     });
//   });

//   if (selectedIndex === -1) {
//     // If no slice is selected, display all projects
//     renderProjects(project2, projectsContainer, 'h2');
//   } else {
//     // Filter projects based on the selectedIndex (which corresponds to the year or label)
//     let filteredProjects = project2.filter((project) => {
//       // Assuming the label corresponds to the year, use the year property to filter
//       return project.year === data[selectedIndex].label; // Adjust as needed based on the structure of your data
//     });
  
//     // Now, render the filtered projects
//     renderProjects(filteredProjects, projectsContainer, 'h2');
//   }
// let selectedIndex = -1;
// let svg = d3.select('svg');
